...
* I opened a terminal in VScode by going to **Terminal** and then **New Terminal**. Then to use **ssh**, I typed the command `$ ssh cs15lsp23pi@ieng6.ucsd.edu` ![Image](connect3.png)
